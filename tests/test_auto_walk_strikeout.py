...
def test_auto_walk(tmp_path):
    ...
    test_game = Game(
        ...
        plays=[
            ...
            Play(inning=1, team=0, batter_id="TEST2", count="00", pitches="", play_description="")
        ]
    )
    ...
    assert current_play.play_description == "W", f"Expected W, got {current_play.play_description}"
